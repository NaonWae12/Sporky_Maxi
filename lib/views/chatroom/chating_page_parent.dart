...
import '../../components/globals/bar/top_bar/top_bar_chat_parent_with_xprt_cmp.dart';

class ChatingPageParent extends StatefulWidget {
  final String roomUuid;
  final String doctorName;

  const ChatingPageParent({
    super.key,
  ...
  @override
  State<ChatingPageParent> createState() => _ChatingPageParentState();
}

class _ChatingPageParentState extends State<ChatingPageParent> {
  ...
  Future<void> _loadMessages({bool silent = false}) async {
    ...
    try {
      ...
      // Hindari "kedip hilang" saat poll jika server sempat balikin list kosong.
          ...
          CmpTagAttention(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Mohon selesaikan percakapan dalam waktu yang tersedia. Jika waktu habis, kamu perlu memulai sesi baru.',
